...
export default function Edit({ role, permissionsByGroup }: Props) {
    const { data, setData, put, processing, errors } = useForm({
        name: role.name || '',
        slug: role.slug || '',
        description: role.description || '',
        permissions: role.permissions.map(p => p.id) || [] as string[],
    });
            ...
            <div className="max-w-5xl p-6">
                <form onSubmit={handleSubmit} className="space-y-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    disabled={['super-admin', 'admin'].includes(role.slug)}
                                />
                    ...
                    <div className="flex justify-end gap-4">
                        ...
                        <Button type="submit" disabled={processing} className="bg-blue-600 hover:bg-blue-700">Update Role</Button>
                    </div>
                </form>
            </div>
        </AppLayout>
