...
import { Pencil, Trash2, ShieldPlus, Shield } from 'lucide-react';
                ...
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            ...
                            <span className="font-bold text-foreground mx-1">"{selectedRole?.name}"</span>
                            from the system and remove all associated users' access attached to it.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
